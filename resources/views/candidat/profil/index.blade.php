...
@section('content')
                                ...
                                <div class="tab-content h-300">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row gx-2">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="nom" name="nom"
                                                                                wire:model="nom" placeholder="nom"
                                                                                value="{{ $candidats->nom }}">
                                                                        </div>
                                                                        @error('nom')
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                wire:model="prenom" placeholder="Prenom"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="date" name="dateNaissance"
                                                                                ...
                                                                                class="form-control" id="dateNaissance"
                                                                ...
                                                                <div class="col-sm-6 col-6">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="lieuNaissance" name="lieuNaissance"
                                                                ...
                                                                <div class="col-sm-6 col-6">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="nina"
                                                                            class="form-label">Nina</label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text">
                                                                                <i class="bi bi-key"></i>
                                                                            </span>
                                                                            <input type="text" class="form-control"
                                                                                name="nina" wire:model="nina"
                                                                                id="nina" placeholder=""
                                                                ...
                                                                <h3 class="text-primary"><i
                                                                        class="bi bi-info-circle me-2"></i>Profile</h3>
                                                                ...
                                                                <div class="row gx-2">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <select class="form-select"
                                                                                    name="diplome_id" id="aj"
                                                                                    wire:model="diplome_id">
                                                                                    <option value="">Choisir votre
                                                                                        niveau d'étude
                                                                                    </option>
                                                                                    @foreach ($diplomes as $diplome)
                                                                                        <option @selected(old('diplome_id', $candidats->diplome_id) == $diplome->id)
                                                                                            value="{{ $diplome->id }}">
                                                                                            {{ $diplome->nom }}
                                                                                        </option>
                                                                                    @endforeach
                                                                    ...
                                                                    <div class="col-sm-6 col-6">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <select class="form-select"
                                                                                    name="type_candidat_id" id="ak"
                                                                                    wire:model="type_candidat_id">
                                                                                    <option value="">Choisir le type
                                                                                        de candidat
                                                                                    </option>
                                                                                    @foreach ($typeCandidats as $typeCandidat)
                                                                                        <option @selected(old('type_candidat_id', $candidats->type_candidat_id) == $typeCandidat->id)
                                                                                            value="{{ $typeCandidat->id }}">
                                                                                            {{ $typeCandidat->nom }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <select class="form-select" name="corp_id"
                                                                                    id="al" wire:model="corp_id">
                                                                                    <option value="">Choisir le corp
                                                                                    </option>
                                                                                    @foreach ($corps as $corp)
                                                                                        <option @selected(old('corp_id', $candidats->corp_id) == $corp->id)
                                                                                            value="{{ $corp->id }}">
                                                                                            {{ $corp->nom }}
                                                                                        </option>
                                                                                    @endforeach
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <select class="form-select"
                                                                                    ...
                                                                                    <option value="">Choisir le
                                                                                        specialité</option>
                                                                                    @if (!empty($specialites))
                                                                                        @foreach ($specialites as $specialite)
                                                                                            <option
                                                                                                @selected(old('specialite_id', $candidats->specialite_id) == $specialite->id)
                                                                                                value="{{ $specialite->id }}">
                                                                                                {{ $specialite->nom }}
                                                                                            </option>
                                                                                        @endforeach
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="email"
                                                                                class="form-label">Localité</label>
                                                                            <div class="input-group">
                                                                                <span class="input-group-text">
                                                                                    <i class="bi bi-pin-map"></i>
                                                                                </span>
                                                                                <select class="form-select"
                                                                                    name="localite_id" id="al"
                                                                                    wire:model="localite_id">
                                                                                    <option value="">Choisir la
                                                                                        Localite</option>
                                                                                    @foreach ($localites as $localite)
                                                                                        <option @selected(old('localite_id', $candidats->localite_id) == $localite->id)
                                                                                            value="{{ $localite->id }}">
                                                                                            {{ $localite->nom }}
                                                                                        </option>
                                                                                    @endforeach
                                                                        ...
                                                                        <!-- Form field end -->
                                                                        <h3 class="text-primary"><i
                                                                                class="bi bi-credit-card-2-front me-2"></i>Dossier
                                                                        </h3>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <strong>Veuillez choisir un fichier sous
                                                                                format(png,jpg,jpeg,pdf)</strong>.
                                                                        </div>
                                                                        <div class="row gx-2">
                                                                                        ...
                                                                                        <div class="m-0">
                                                                                            <label for="ar"
                                                                                                ...
                                                                                                de nationalité<span
                                                                                                    class="text-danger">*</span></label>
                                                                                            <input class="form-control"
                                                                                                name="certificatNationalite"
                                                                                                type="file"
                                                                                                wire:model="certificatNationalite"
                                                                                                id="ar">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="card mb-4">
                                                                                    <div class="card-body">
                                                                                        <div class="m-0">
                                                                                            ...
                                                                                            <input class="form-control"
                                                                                                name="lettreEquivalence"
                                                                                                type="file"
                                                                                                wire:model="lettreEquivalence"
                                                                                                id="as">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-xl-4 col-sm-6 col-12">
                                            <div class="p-3">
                                                <img src="{{ asset('assets/images/login.svg') }}" alt="Contactez-nous"
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                            ...
                                            <div class="card border mb-3">
                                                <div class="card-body">
                                                    <form method="POST" action="{{ route('candidat.updatePassword') }}">
                                                        @csrf
                                                        <div class="mb-3">
                                                            <label class="form-label" for="currentPassword">Mot de passe
                                                                actuel <span class="text-danger">*</span></label>
                                                            <div class="input-group">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" for="pwd">Nouveau mot de passe
                                                                <span class="text-danger">*</span></label>
                                                            <div class="input-group">
                                                                <input type="password" name="password" id="pwd"
                                                                    class="form-control"
                                                                    placeholder="Votre nouveau mot de passe doit comporter au moins 10 caractères">
                                                                <button class="btn btn-outline-secondary" type="button">
                                                                    <i class="bi bi-eye text-black"></i>
                                                                </button>
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" for="pwd2">Confirmer le nouveau
                                                            ...
                                                            <div class="col-12 d-flex justify-content-start">
                                                                <div class="form-group has-icon-left">
                                                                    ...
                                                                    <span class="invalid" id="number">Un
                                                                        chiffre</span><br>
                                                                    <span class="invalid" id="lenght">10 caractères
                                                                        minimum</span><br>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="text-center">
                                                            <button id="sauv" type="submit" class="btn btn-primary"
                                                                disabled>Mettre à jour</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        pwd.onkeyup = function() {
            ...
            if (pwd.value.length >= 10 && pwd.value.match(chiffre) && pwd.value.match(caractere) && pwd.value.match(
