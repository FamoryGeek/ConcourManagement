                ...
                <div class="card-body">
                    ...
                    @if ($resultats)
                        @if ($resultats->isNotEmpty())
                            <form wire:submit.prevent="saveNote" method="post">
                                {{-- <div>
                                    ...
                                    <tbody>
                                        @foreach ($resultats as $index => $candidat)
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" wire:model="epreuveTechnique.{{ $candidat->id  }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" wire:model="cultureGeneral.{{ $candidat->id  }}">
                                                </td>
                                                <td class="d-none">
                                                    <input type="hidden" value="{{ $candidat->id }}" wire:model="candidat_id.{{ $candidat->id  }}">
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
