                ...
                <form wire:submit.prevent="saveCategorie">
                    <div class="card-body">
                        ...
                        <div class="row gx-4">
                            <div class=" ">
                                <div class="mb-3">
                                    <label class="form-label mb-3" for="a1">Nom de la categorie<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="a1" wire:model="nom"
                                        placeholder="Entrez le nom de la categorie" autofocus>
                                </div>
                                @error('nom')
            ...
            <div class="modal-body">
                <form wire:submit.prevent="destroyCategorie">
                    <div class="card-body">
                        ...
                        <div class="row gx-4">
                            <div class=" ">
                                Voulez vous vraiment suprimer cette categorie ?
                            </div>
                        </div>
                        <!-- Row ends -->
                    </div>
